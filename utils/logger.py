...
def initLogger(log_level="DEBUG", log_path=None, logfile_name=None, clear=False, backup_count=0):
    ...
    if logfile_name:
        ...
        print("init logger ... save to file:", logfile)
        handler_file = TimedRotatingFileHandler(logfile, "midnight", backupCount=backup_count, encoding='utf-8')
        ...
        print("init logger ... just output to console")
